...
public class UserDB {
    ...
    public void delete(User user) throws Exception {
        ...
        EntityTransaction trans = em.getTransaction();
        try {
            Role role = user.getRole(); //get the role the user belongs to
            role.getUserList().remove(user); // if a user is deleted, the user must be removed from the of users belong to the role. 
            trans.begin();
